...
| 2026-08-27 | 4.1 | Проверена работа BLE через logcat: `adb logcat --pid=$(adb shell pidof com.bletest.bletextviewer) \| findstr "BleClient TextDisplay BleBridge"` — логи читаются, скан/коннект/нотификации работают. |
